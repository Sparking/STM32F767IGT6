...
static i2c_speed_t i2c_speed[3] = {
    [I2C_100K_SPEED] = {
        .t_hold_start = 600,   /* 0.6us */
        .t_scl_low = 1300,     /* 1.3us */
        .t_scl_high = 600,     /* 0.6us */
        .t_setup_start = 600,  /* 0.6us */
        .t_hold_sda = 0,       /* 0us */
        .t_setup_sda = 100,    /* 100ns */
        .t_raise = 300,        /* 300ns */
        .t_fall = 300,         /* 300ns */
        .t_setup_stop = 600,   /* 0.6us */
        .t_bus_free = 1300,    /* 1.3us */
        .t_valid_data = 900,   /* 0.9us */
        .t_vaild_ack = 900,    /* 0.9us */},
    [I2C_400K_SPEED] = {
        /* reference from mpu9250 */
        .t_hold_start = 600,   /* 0.6us */
        .t_scl_low = 1300,     /* 1.3us */
        .t_scl_high = 600,     /* 0.6us */
        .t_setup_start = 600,  /* 0.6us */
...
__attribute__(( always_inline )) static inline uint16_t i2c_count_speed(
...
void IIC_Start(i2c_device_t *IIC)
{
        ...
        delayus(4);
        IIC_ResetSDA(IIC);
        delayus(i2c_count_speed(IIC->speed->t_fall
...
void IIC_Stop(i2c_device_t *IIC)
{
        ...
        delayus(4);
        IIC_SetSCL(IIC);
        delayus(i2c_count_speed(IIC->speed->t_raise
...
void IIC_SendAck(i2c_device_t *IIC, unsigned char ack)
{
        ...
        delayus(i2c_count_speed(IIC->speed->t_raise)); 
        IIC_SetSCL(IIC);
        delayus(i2c_count_speed(IIC->speed->t_raise) + 1);
        IIC_ResetSCL(IIC);
}
...
void IIC_WriteByte(i2c_device_t *IIC, unsigned char data)
{
        ...
        IIC_ResetSCL(IIC);
        for (i = 0U; i < 8U; i ++) {
                delayus(i2c_count_speed(IIC->speed->t_hold_sda
